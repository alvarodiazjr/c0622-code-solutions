...
const { title: bookTitle, author: bookAuthor, libraryID: idNum } = book2;

console.log(`The title of the book is ${bookTitle}, the author is ${bookAuthor}, and the library id is ${idNum}`);
